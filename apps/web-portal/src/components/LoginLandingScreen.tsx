    ...
    try {
      ...
      if (!address && typeof window !== "undefined" && (window as any).ethereum) {
        try {
          ...
          console.warn("Metamask/Browser wallet connection error:", walletErr);
        }
      }
      ...
      try {
        ...
        console.warn("Backend API unreachable, using seamless client AuthSession fallback:", apiErr);
        // Seamless client session fallback for mobile & multi-device offline/demo access
        onLoginSuccess({
          address,
